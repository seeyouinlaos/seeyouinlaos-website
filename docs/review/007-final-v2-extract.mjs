/* 007 — FINAL V2 FULL-WEBSITE TEXT EXTRACTION · generator for docs/review/007-final-v2-text.txt (003: after the Owner patch and the venue experience)
...
const OUT = path.join(ROOT, 'docs/review/007-final-v2-text.txt');
...
function renderAll() {
  ...
  const out = [];
  out.push('007 — FINAL V2 FULL-WEBSITE TEXT EXTRACTION · see you in laos.');
...
fs.writeFileSync(path.join(ROOT, 'docs/review/.007-v2-a11y-check.json'), JSON.stringify(a11yIssues, null, 2));
