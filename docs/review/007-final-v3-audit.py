...
issue('Invitation register · active guests', '47 individual invitations, 47 unique credentials, 2 cancelled (no code, no index entry, no record); one credential (G001) rotated on 16 Sep 2026 — the other 46 unchanged; auth coverage 47 / 47 on production', 'FINAL OWNER DECISION (16 Sep 2026): "Operations Master Contacts is not the website invitation source of truth. Active Invitation Register governs website access." The Operations Master Guestlist tab is a contact register ("Contacts (No Supplier)" — "Everyone we call during the trip"): 59 contacts, 57 rows with a Guest - … role — broader CRM / contact scope, not invitation authority; the numeric difference is not a release conflict. Three contact ↔ invitation identities (CON009, CON046, CON048) stay CONTACT / INVITATION MAPPING UNCONFIRMED · NON-BLOCKING FOR WEBSITE RELEASE; contacts without invitations, invitations without a contact row, rooming placeholders and the duplicate contact id CON060 are documented operations data-quality items (docs/review/004-guest-reconciliation-summary.txt)', 'The active website invitation register (src/register-audit.mjs) · Owner decision 16 Sep 2026 · docs/review/004-guest-reconciliation-summary.txt', 'SOURCE MISSING', 'SOURCE-SCOPE DIFFERENCE · NON-BLOCKING OPERATIONAL RECONCILIATION. The register is the source of truth for website authentication, invitations and private journey access: ACTIVE WEBSITE GUESTS 47 · INVITATIONS 47 · UNIQUE ACTIVE CREDENTIALS 47 · MISSING 0 · DUPLICATES 0 · AUTH COVERAGE 47 / 47. No identity was inferred, no invitation created or deleted, no code changed.')
