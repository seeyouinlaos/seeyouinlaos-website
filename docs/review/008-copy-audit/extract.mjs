...
const OUT = path.join(ROOT, 'docs/review/008-copy-audit/text.txt');
...
fs.writeFileSync(path.join(ROOT, 'docs/review/008-copy-audit/.a11y-check.json'), JSON.stringify(a11yIssues, null, 2));
