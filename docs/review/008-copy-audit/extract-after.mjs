/* 008 — COPY AUDIT · FULL-WEBSITE TEXT EXTRACTION (fresh, after P0) · generator for docs/review/007-final-v3-text.txt (004: after the security remediation, the Owner's venue mapping, the final public / private information architecture and the guest reconciliation of 16 Sep 2026 — a new version, the v2 files stay as history)
...
const OUT = path.join(ROOT, 'docs/review/008-copy-audit/text-after.txt');
...
const tmp = fs.mkdtempSync('/Users/thongantang/.claude/jobs/d5f48d27/tmp/008x-');
...
function renderAll() {
  ...
  const out = [];
  out.push('008 — COPY AUDIT · FULL-WEBSITE TEXT EXTRACTION (fresh, after P0) · see you in laos.');
