...
if (!LIVE) {
  ...
  /* ===== 4 · THE SEAT GATE (T003 Cleo, the wedding): attending the dinner with no seat blocks Review & Send; the seat confirmed enables it; a declined event needs none ===== */
  {
    ...
    const srv0 = await postRegister(p, { selections: [{ id: 'guesthouse', price: 0, qty: 1, stay: 'guesthouse', room: 'guest-house', unit: 'A', complimentary: true }], totalUsd: 0, contact: { email: 'cleo.test@example.org', phone: '+66 81 000 0000' }, stages: { wedstay: 'selected' }, templeCeremony: { guests: [{ guestId: 'T003', events: { temple: 'Not joining', coffee: 'Joining', vows: 'Joining', dinner: 'Joining' }, finale: 'The pool jump', finaleKey: 'pool', sangkhathanState: 'Not applicable', sangkhathan: false }] }, guestRecord: { scope: { bangkok: false, vientianePreWedding: false, vientianeWedding: true, china: false, none: false, at: '2026-09-21T10:00:00.000Z' }, dress: { all: true }, allergy: { answer: 'no' }, photo: { at: 'x' }, guests: [{ guestId: 'T003', name: 'Cleo', profile: { coffeetea: 'Tea', flavor: 'Pandan', drink: 'Water', film: 'Ran', genres: ['Pop'] } }] } });
  ...
  /* ===== 5 · THE WORKER REFUSES AN INCOMPLETE TRIP (T002 Ben): an unresolved stage · a declined mandatory train · a claimed but unheld stay; a complete one is accepted ===== */
  {
    ...
    const base = { contact: { email: 'ben.test@example.org', phone: '+66 81 000 0000' }, guestRecord: { scope: { bangkok: false, vientianePreWedding: false, vientianeWedding: false, china: true, none: false, at: '2026-09-21T10:00:00.000Z' }, allergy: { answer: 'no' }, photo: { at: 'x' }, guests: [{ guestId: 'T002', name: 'Ben', profile: { coffeetea: 'Tea', flavor: 'Pandan', drink: 'Water', film: 'Ran', genres: ['Pop'] } }] } };
