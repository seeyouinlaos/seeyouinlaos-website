...
function seatingView(inv, state) {
  ...
  return { ok: true, open: state.open, frozen: state.frozen, configured: { ceremony: true, dinner: true },
    ...
    dinner: { sides: { T: cfg.dinner.sides.T.map((s) => dress(s, 'dinner')), B: cfg.dinner.sides.B.map((s) => dress(s, 'dinner')) }, totalPeople: 50 }, capacity: { ceremony: { guestSeats: 50, left: 20, right: 30 }, dinner: { guestSeats: 50, top: 25, bottom: 25, totalPeople: 50 } }, mine };
}
