...
if (!LIVE) {
  ...
  /* ===== 4 · THE SERVER-SIDE COMPLETION GATE — the Worker's own answer, no UI involved ===== */
  {
    ...
    const gr0 = { allergy: { answer: 'no' }, photo: { at: 'x' }, guests: [{ guestId: 'T002', name: 'Ben', profile: { coffeetea: 'Tea', flavor: 'Pandan', drink: 'Water', film: 'Ran', genres: ['Pop'] } }] };
