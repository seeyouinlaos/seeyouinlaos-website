/* STICKY SHELL REGRESSION (Owner, 18 Sep 2026): on every long guest-facing page, after a deep scroll, the header row
   ...
   My Profile · Sign out) are inside the viewport, and nothing scrolls underneath them. Exits 1 on any failure.
     node docs/acceptance/2026-09-18-account-ia/shell-scroll.mjs <origin> <scratchpad-with-synth-codes> [widths…] */
...
const PRIVATE = ['profile.html', 'your-journey.html', 'cart.html', 'review.html', 'about-you.html', 'wedding.html', 'wedding-preparation.html', 'room.html?stay=souphattra&room=heritage', 'transport.html?id=c86', 'tickets.html'];
