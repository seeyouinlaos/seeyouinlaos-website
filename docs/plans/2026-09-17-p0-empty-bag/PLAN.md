...
After F-3: suite 305/305, release check PASSED, stage E2E 49/49 re-run, 48 screenshots re-shot (0 overflow). The closing Codex pass is recorded in `docs/acceptance/2026-09-17-p0-empty-bag/README.md`.
