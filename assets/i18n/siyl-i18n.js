...
(function () {
  ...
  E("· a Buddhist morning ceremony until around midday ·",
    ...
    "・正午ごろまでの朝の仏教儀式・");
  E("05:15 PM", "17:15 Uhr", "17:15 น.", "17:15");
  E("06:15 PM", "18:15 Uhr", "18:15 น.", "18:15");
  E("07:00 AM", "07:00 Uhr", "07:00 น.", "7:00");
  E("09:00 PM", "21:00 Uhr", "21:00 น.", "21:00");
  E("09:00 – 10:00 AM", "09:00 – 10:00 Uhr", "09:00 – 10:00 น.", "9:00〜10:00");
  E("12:00 – 4:15 PM", "12:00 – 16:15 Uhr", "12:00 – 16:15 น.", "12:00〜16:15");
  E("12:00 PM", "12:00 Uhr", "12:00 น.", "12:00");
  E("Sunday, 28 Feb · 06:15 PM", "Sonntag, 28. Feb · 18:15 Uhr", "อาทิตย์ 28 ก.พ. · 18:15 น.", "2月28日（日）18:15");
  E("Welcome Dinner", "Welcome Dinner", "งานเลี้ยงต้อนรับ", "ウェルカムディナー");
  E("Pool Social Hour", "Pool Social Hour", "ช่วงเวลาสังสรรค์ริมสระ", "プールでのソーシャルアワー");
  E("Cake Cutting", "Der Anschnitt der Torte", "พิธีตัดเค้ก", "ケーキカット");
  E("Alms Giving · in the morning", "Morgenritual · am Morgen", "ตักบาตร · ยามเช้า", "托鉢の儀・朝");
  E("through the day", "über den Tag verteilt", "ตลอดทั้งวัน", "終日");
  E("A short walk from the Heritage to Wat Ong Teu: alms offered in the morning light, nothing hurried. Then the day opens slowly toward the vows.",
    "Ein kurzer Weg vom Heritage zum Wat Ong Teu: Almosen im Morgenlicht, nichts eilig. Dann öffnet sich der Tag langsam auf das Eheversprechen zu.",
    "เดินเพียงไม่กี่ก้าวจากเฮอริเทจสู่วัดองค์ตื้อ ตักบาตรในแสงเช้า อย่างไม่เร่งรีบ แล้ววันจึงค่อย ๆ เปิดสู่พิธีกล่าวคำสัญญา",
    "ヘリテージからワット・オンテウへは歩いてすぐ。朝の光の中で托鉢を——急がず、そして一日はゆっくりと誓いへ向かいます。");
  E("The wedding day begins at Wat Ong Teu Temple: alms offered from nine in the morning light, unhurried and full of meaning.",
    "Der Hochzeitstag beginnt im Wat Ong Teu Tempel: Almosen ab neun Uhr im Morgenlicht, ohne Eile und voller Bedeutung.",
    "วันแต่งงานเริ่มต้นที่วัดองค์ตื้อ ตักบาตรตั้งแต่เก้าโมงในแสงเช้า อย่างไม่เร่งรีบและเปี่ยมความหมาย",
    "結婚式の一日はワット・オンテウ寺院から。9時、朝の光の中での托鉢——急がず、意味に満ちた時間です。");
  E("The wedding day begins at Wat Ong Teu Temple in Vientiane: a short walk from the Heritage, alms offered from nine to ten in the morning light. The afternoon belongs to Le Café and the Secret Garden — coffee, cake and long easy hours before the vows.",
    "Der Hochzeitstag beginnt im Wat Ong Teu Tempel in Vientiane: ein kurzer Weg vom Heritage, Almosen von neun bis zehn im Morgenlicht. Der Nachmittag gehört dem Le Café und dem Secret Garden — Kaffee, Kuchen und lange, leichte Stunden vor dem Eheversprechen.",
    "วันแต่งงานเริ่มต้นที่วัดองค์ตื้อ เวียงจันทน์ เดินเพียงไม่กี่ก้าวจากเฮอริเทจ ตักบาตรเก้าโมงถึงสิบโมงในแสงเช้า ช่วงบ่ายเป็นของเลอ คาเฟ่และซีเคร็ตการ์เดน กาแฟ เค้ก และชั่วโมงอันผ่อนคลายก่อนพิธีกล่าวคำสัญญา",
    "結婚式の一日は、ビエンチャンのワット・オンテウ寺院から。ヘリテージから歩いてすぐ、9時から10時まで朝の光の中で托鉢を。午後はル・カフェとシークレットガーデンで——コーヒーとケーキ、誓いの前のゆったりとした時間。");
  E("a slow morning at the Heritage", "ein langsamer Morgen im Heritage", "เช้าอันเนิบช้าที่เฮอริเทจ", "ヘリテージでのゆっくりとした朝");
  E("long, easy hours in the garden before the vows", "lange, leichte Stunden im Garten vor dem Eheversprechen", "ชั่วโมงอันผ่อนคลายในสวนก่อนพิธีกล่าวคำสัญญา", "誓いの前、庭でのゆったりとした時間");
  E("one last shared song, the cake and the final photograph — the formal programme closes at 09:30 PM, the evening may carry on",
    "ein letztes gemeinsames Lied, die Torte und das letzte Foto — das offizielle Programm endet um 21:30 Uhr, der Abend darf weitergehen",
    "เพลงสุดท้ายที่ร้องร่วมกัน เค้ก และภาพถ่ายสุดท้าย กำหนดการทางการจบเวลา 21:30 น. แต่ค่ำคืนยังไปต่อได้",
    "最後にみなで分かち合う歌、ケーキ、そして最後の一枚——正式なプログラムは21:30に幕を閉じ、夜は続いてもかまいません");
  E("the evening the journey gathers — with an optional stroll to the Night Market afterwards",
    "der Abend, an dem die Reise zusammenkommt — danach nach Lust und Laune ein Bummel über den Night Market",
    "ค่ำคืนที่ทุกเส้นทางมาบรรจบ แล้วเลือกเดินเล่นตลาดกลางคืนต่อได้ตามใจ",
    "旅が一つに集う夜——そのあとは気の向くままナイトマーケットへ");
  E("· Lao Derm", "· Lao Derm", "· ลาวเดิม", "・ラオ・ダーム");
  E("Lao Derm, Vientiane", "Lao Derm, Vientiane", "ลาวเดิม เวียงจันทน์", "ラオ・ダーム（ビエンチャン）");
  E("· Le Café · Secret Garden", "· Le Café · Secret Garden", "· เลอ คาเฟ่ · ซีเคร็ตการ์เดน", "・ル・カフェ／シークレットガーデン");
  E("Le Café · Secret Garden", "Le Café · Secret Garden", "เลอ คาเฟ่ · ซีเคร็ตการ์เดน", "ル・カフェ／シークレットガーデン");
  E("· Sivilai Dining Room", "· Sivilai Dining Room", "· ห้องอาหารสิวิไล", "・シヴィライ・ダイニングルーム");
  E("· Wat Ong Teu", "· Wat Ong Teu", "· วัดองค์ตื้อ", "・ワット・オンテウ");
  E("· a short walk from the Heritage ·", "· ein kurzer Weg vom Heritage ·", "· เดินไม่กี่ก้าวจากเฮอริเทจ ·", "・ヘリテージから徒歩すぐ・");
  E("· arrivals by air and via Nong Khai · met, transferred and checked in",
    "· Ankünfte per Flug und über Nong Khai · abgeholt, transferiert und eingecheckt",
    "· เดินทางถึงทั้งทางเครื่องบินและผ่านหนองคาย · มีคนรับ ส่ง และเช็คอินให้",
    "・空路とノーンカーイ経由での到着・お出迎え、送迎、チェックインまで");
  E("· the grand entrance, dinner and music", "· der große Auftritt, Dinner und Musik", "· แกรนด์เอนทรานซ์ มื้อค่ำ และดนตรี", "・グランドエントランス、ディナー、音楽");
  E("· the pool opens after the vows", "· der Pool öffnet nach dem Eheversprechen", "· สระเปิดหลังพิธีกล่าวคำสัญญา", "・誓いのあと、プールが開きます");
  E("Breakfast", "Frühstück", "อาหารเช้า", "朝食");
  E("The evening the journey gathers: dinner together at Lao Derm, with an optional stroll to the Night Market afterwards.",
    "Der Abend, an dem die Reise zusammenkommt: gemeinsames Dinner im Lao Derm — danach nach Lust und Laune ein Bummel über den Night Market.",
    "ค่ำคืนที่ทุกเส้นทางมาบรรจบ มื้อค่ำร่วมกันที่ลาวเดิม แล้วเลือกเดินเล่นตลาดกลางคืนต่อได้ตามใจ",
    "旅が一つに集う夜——ラオ・ダームでのディナー。そのあとは気の向くままナイトマーケットへ。");
  E("The wedding day begins at Wat Ong Teu: a short walk from the Heritage, alms offered in the morning light, nothing hurried.",
    "Der Hochzeitstag beginnt im Wat Ong Teu: ein kurzer Weg vom Heritage, Almosen im Morgenlicht, nichts eilig.",
    "วันแต่งงานเริ่มต้นที่วัดองค์ตื้อ เดินไม่กี่ก้าวจากเฮอริเทจ ตักบาตรในแสงเช้า อย่างไม่เร่งรีบ",
    "結婚式の一日はワット・オンテウから。ヘリテージから歩いてすぐ、朝の光の中で托鉢を——急がずに。");
  E("Long, easy hours in the Secret Garden — coffee, cake and time together before the vows.",
    "Lange, leichte Stunden im Secret Garden — Kaffee, Kuchen und gemeinsame Zeit vor dem Eheversprechen.",
    "ชั่วโมงอันผ่อนคลายในซีเคร็ตการ์เดน กาแฟ เค้ก และเวลาด้วยกันก่อนพิธีกล่าวคำสัญญา",
    "シークレットガーデンでのゆったりとした時間——コーヒーとケーキ、誓いの前のひととき。");
  E("Alms Giving at Wat Ong Teu", "Morgenritual im Wat Ong Teu", "ตักบาตรที่วัดองค์ตื้อ", "ワット・オンテウでの托鉢");
  E("Coffee & Cake in the Secret Garden", "Kaffee & Kuchen im Secret Garden", "กาแฟและเค้กในซีเคร็ตการ์เดน", "シークレットガーデンでのコーヒー＆ケーキ");
  E("Alms Giving, Coffee & Cake, Vow Ceremony and Wedding Dinner.",
    "Morgenritual, Kaffee & Kuchen, Eheversprechen und Hochzeitsdinner.",
    "ตักบาตร กาแฟและเค้ก พิธีกล่าวคำสัญญา และงานเลี้ยงมงคลสมรส",
    "托鉢、コーヒー＆ケーキ、誓いのセレモニー、ウェディングディナー。");
  ...
  E("Join under My Travel", "Unter „Mein Reiseweg“ beitreten", "เข้าร่วมได้ที่ การเดินทางของฉัน", "「旅の手配」からご参加ください");
  E("Choose under My Travel", "Unter „Mein Reiseweg“ wählen", "เลือกได้ที่ การเดินทางของฉัน", "「旅の手配」からお選びください");
