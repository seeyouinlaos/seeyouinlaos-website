...
(function () {
  ...
  E("Kunming Cherry Blossoms", "Kunming-Kirschblüten", "ซากุระคุนหมิง", "昆明の桜");
  E("Kunming · Yunnan", "Kunming · Yunnan", "คุนหมิง · ยูนนาน", "昆明・雲南");
  E("Nature · Garden · Seasonal · Photography", "Natur · Garten · Saisonal · Fotografie", "ธรรมชาติ · สวน · ตามฤดูกาล · ถ่ายภาพ", "自然・庭園・季節・写真");
  E("Seasonal", "Saisonal", "ตามฤดูกาล", "季節限定");
  E("Spring", "Frühling", "ฤดูใบไม้ผลิ", "春");
  E("In spring, Kunming's gardens shift into layers of pink blossom, water, stone paths and traditional architecture.", "Im Frühling verwandeln sich Kunmings Gärten in Schichten aus rosa Blüten, Wasser, Steinwegen und traditioneller Architektur.", "ในฤดูใบไม้ผลิ สวนของคุนหมิงกลายเป็นชั้นของดอกไม้สีชมพู สายน้ำ ทางเดินหิน และสถาปัตยกรรมดั้งเดิม", "春、昆明の庭園は桃色の花と水、石畳、伝統建築の重なりへと姿を変えます。");
  E("The most atmospheric locations bring together Yunnan cherry blossoms and flowering begonia with streams, small cascades, white walls, dark tiled roofs and planted walkways — less a single attraction than a seasonal landscape that changes with light, weather and the stage of bloom.", "Die stimmungsvollsten Orte verbinden Yunnan-Kirschblüten und blühende Begonien mit Bächen, kleinen Kaskaden, weißen Mauern, dunklen Ziegeldächern und bepflanzten Wegen — weniger eine einzelne Attraktion als eine saisonale Landschaft, die sich mit Licht, Wetter und Blühstand wandelt.", "จุดที่มีบรรยากาศที่สุดผสานซากุระยูนนานและบีโกเนียบานเข้ากับลำธาร น้ำตกเล็ก กำแพงขาว หลังคากระเบื้องเข้ม และทางเดินร่มไม้ ไม่ใช่จุดชมเดียวแต่เป็นภูมิทัศน์ตามฤดูกาลที่เปลี่ยนตามแสง อากาศ และช่วงการบาน", "最も趣のある場所では、雲南桜と海棠の花が、小川や小さな滝、白壁、瓦屋根、緑の小径と重なり合います——ひとつの名所というより、光と天気、開花とともに移ろう季節の風景です。");
  E("Seasonal note — Kunming's main cherry blossom season usually builds from mid-March into April. Our early-March visit may fall before peak bloom, so actual flowering conditions will depend on the season.", "Saisonhinweis — Kunmings Hauptblüte baut sich üblicherweise von Mitte März bis in den April auf. Unser Besuch Anfang März kann vor der Vollblüte liegen; die tatsächlichen Bedingungen hängen vom Jahr ab.", "หมายเหตุฤดูกาล — ซากุระคุนหมิงมักบานเต็มที่ช่วงกลางมีนาคมถึงเมษายน การมาเยือนต้นมีนาคมของเราอาจก่อนช่วงบานเต็มที่ สภาพดอกไม้จริงขึ้นอยู่กับปีนั้นๆ", "季節のご案内——昆明の桜は例年3月中旬から4月にかけて見頃を迎えます。私たちの3月上旬の訪問は満開前となる可能性があり、実際の開花はその年の気候によります。");
  E("Yuantongshan (Wuhua District) — the classic Kunming blossom garden: Yunnan cherry, weeping begonia and a dense pink canopy in an established city park.", "Yuantongshan (Bezirk Wuhua) — der klassische Blütengarten Kunmings: Yunnan-Kirsche, hängende Begonie und ein dichtes rosa Blätterdach in einem gewachsenen Stadtpark.", "หยวนทงซาน (เขตอู่หัว) — สวนซากุระคลาสสิกของคุนหมิง ซากุระยูนนาน บีโกเนียช่อย้อย และเรือนยอดสีชมพูหนาแน่นในสวนเมืองเก่าแก่", "円通山（五華区）——昆明の桜の名園。雲南桜と枝垂れ海棠が、歴史ある市中の庭園に濃密な桃色の天蓋をつくります。");
  E("Kunming suburban park (Xishan District) — a broader, quieter garden landscape for more spacious, immersive flower viewing.", "Kunminger Vorstadtpark (Bezirk Xishan) — eine weitere, ruhigere Gartenlandschaft für großzügigeres, immersives Blütenschauen.", "สวนชานเมืองคุนหมิง (เขตซีซาน) — ภูมิทัศน์สวนที่กว้างและเงียบกว่า สำหรับการชมดอกไม้แบบแช่มชื่นและกว้างขวาง", "昆明郊外の公園（西山区）——より広く静かな庭園風景で、ゆったりと花に浸る時間を。");
  E("Best light — mornings 09:00–11:00 and late afternoons 16:00–18:00; midday light is harsh for photography. Perspectives worth seeking: hanging branches, water and blossom layers, stone-path depth, white-wall framing, backlit petals.", "Bestes Licht — vormittags 09:00–11:00 und spätnachmittags 16:00–18:00; die Mittagssonne ist hart fürs Fotografieren. Lohnende Perspektiven: hängende Zweige, Wasser- und Blütenschichten, Steinweg-Tiefe, Rahmung durch weiße Mauern, Gegenlicht in den Blüten.", "แสงที่ดีที่สุด — ช่วงเช้า 09:00–11:00 และบ่ายแก่ 16:00–18:00 แสงเที่ยงแข็งเกินไปสำหรับการถ่ายภาพ มุมที่น่าลอง กิ่งย้อย ชั้นน้ำและดอกไม้ ความลึกของทางเดินหิน กรอบกำแพงขาว กลีบดอกย้อนแสง", "美しい光——午前9〜11時と夕方16〜18時。昼の光は写真には強すぎます。おすすめの視点：枝垂れる枝、水面と花の重なり、石畳の奥行き、白壁のフレーム、逆光に透ける花びら。");
  E("Good to know — bloom timing varies by year and weather; spring temperatures shift and Yunnan sun can be strong; allow two to three unhurried hours; please leave branches and planting untouched.", "Gut zu wissen — der Blühzeitpunkt variiert je nach Jahr und Wetter; Frühlingstemperaturen schwanken und die Yunnan-Sonne kann stark sein; plant zwei bis drei entspannte Stunden; bitte Zweige und Pflanzungen unberührt lassen.", "ควรรู้ — ช่วงการบานต่างกันตามปีและอากาศ อุณหภูมิฤดูใบไม้ผลิแปรผันและแดดยูนนานอาจแรง เผื่อเวลาสองถึงสามชั่วโมงแบบไม่เร่งรีบ กรุณาอย่าแตะต้องกิ่งไม้และแปลงปลูก", "ご参考——開花は年と天候により変わります。春の気温は変わりやすく雲南の日差しは強めです。2〜3時間ゆったりと。枝や植栽には触れずにお楽しみください。");
  E("Bangkok — the journey begins in Thailand", "Bangkok — die Reise beginnt in Thailand", "กรุงเทพฯ — จุดเริ่มต้นการเดินทางในประเทศไทย", "バンコク——旅はタイから始まります");
  E("Vientiane — Patuxai at twilight in the heart of the Lao capital", "Vientiane — der Patuxai in der Abenddämmerung im Herzen der laotischen Hauptstadt", "เวียงจันทน์ — ประตูชัยปะตูไซยามพลบค่ำ ใจกลางเมืองหลวงลาว", "ビエンチャン——ラオスの首都の中心、黄昏のパトゥーサイ");
  E("Kunming — Yunnan blossom above traditional rooflines", "Kunming — Yunnan-Blüten über traditionellen Dachlinien", "คุนหมิง — ดอกไม้ยูนนานเหนือแนวหลังคาดั้งเดิม", "昆明——伝統の屋根の上に咲く雲南の花");
  E("Lijiang — Jade Dragon Snow Mountain over the Baisha valley", "Lijiang — der Jadedrachen-Schneeberg über dem Baisha-Tal", "ลี่เจียง — ภูเขาหิมะมังกรหยกเหนือหุบเขาไป๋ซา", "麗江——白沙の谷にそびえる玉龍雪山");
  E("Experiences", "Erlebnisse", "ประสบการณ์", "体験");
  E("Places along", "Orte entlang", "สถานที่ตลอด", "旅路に沿う");
  E("the journey.", "der Reise.", "เส้นทางการเดินทาง", "場所たち。");
  E("Louis Vuitton Visionary Journeys", "Louis Vuitton Visionary Journeys", "Louis Vuitton Visionary Journeys", "Louis Vuitton Visionary Journeys");
  E("The house opens its world: an exhibition of craft, travel and imagination staged as architecture.", "Das Haus öffnet seine Welt: eine Ausstellung über Handwerk, Reisen und Imagination, inszeniert als Architektur.", "เมซงเปิดโลกของตน นิทรรศการว่าด้วยงานฝีมือ การเดินทาง และจินตนาการ จัดวางดั่งสถาปัตยกรรม", "メゾンが世界を開く——工芸と旅、想像力を建築として魅せる展覧会。");
  E("Sukhumvit’s design quarter — cascading gardens, galleries of shops and city energy.", "Sukhumvits Design-Quartier — kaskadierende Gärten, Shop-Galerien und Stadtenergie.", "ย่านดีไซน์ของสุขุมวิท สวนลดหลั่น แกลเลอรีร้านค้า และพลังของเมือง", "スクンビットのデザイン街区——段々の庭園とショップギャラリー、都市の熱気。");
  E("An intimate evening alternative — a small bar of precision and warmth.", "Eine intime Abend-Alternative — eine kleine Bar voller Präzision und Wärme.", "ทางเลือกยามค่ำอันเป็นส่วนตัว บาร์เล็กๆ ที่แม่นยำและอบอุ่น", "親密な夜のもう一つの選択——精密さと温もりの小さなバー。");
  E("A sharing-menu evening alternative — fine dining made convivial.", "Eine Sharing-Menü-Alternative am Abend — Fine Dining, gesellig gemacht.", "ทางเลือกมื้อค่ำแบบแชร์ริ่ง ไฟน์ไดนิ่งในบรรยากาศเป็นกันเอง", "シェアメニューの夜のもう一つの選択——打ち解けたファインダイニング。");
  E("River Moon", "River Moon", "River Moon", "River Moon");
  E("Riverside · Landscape · Dining", "Flussufer · Landschaft · Dining", "ริมแม่น้ำ · ภูมิทัศน์ · อาหาร", "川辺・風景・ダイニング");
  E("Everyday Vientiane — a local stop between the moments.", "Alltägliches Vientiane — ein lokaler Zwischenstopp.", "เวียงจันทน์ในชีวิตประจำวัน จุดแวะท้องถิ่นระหว่างช่วงเวลา", "日常のビエンチャン——合間に立ち寄る地元のひととき。");
  E("A Vientiane classic — Lao cooking in a colonial house at the heart of the city.", "Ein Vientiane-Klassiker — Lao-Küche in einem Kolonialhaus im Herzen der Stadt.", "คลาสสิกเวียงจันทน์ อาหารลาวในบ้านโคโลเนียลกลางเมือง", "ビエンチャンの定番——街の中心、コロニアル邸宅でのラオ料理。");
  E("A quiet design café — considered coffee in a considered room.", "Ein stilles Design-Café — durchdachter Kaffee in einem durchdachten Raum.", "คาเฟ่ดีไซน์อันเงียบสงบ กาแฟพิถีพิถันในห้องพิถีพิถัน", "静かなデザインカフェ——考え抜かれた部屋で味わう一杯。");
  E("Red roofs along the Mekong at dusk — lanterns, stalls and the city out for the evening.", "Rote Dächer am Mekong in der Dämmerung — Laternen, Stände und die Stadt am Abend.", "หลังคาแดงเรียงรายริมโขงยามพลบค่ำ โคมไฟ แผงค้า และผู้คนออกมาใช้ค่ำคืน", "夕暮れのメコン沿いに連なる赤い屋根——提灯と屋台、宵の街。");
  ...
  E("Vientiane · the wedding", "Vientiane · die Hochzeit", "เวียงจันทน์ · งานแต่งงาน", "ビエンチャン・結婚式");
  /* Vientiane city portrait (owner Vientiane folder + owner article, Sep 2026) */
  E("Gold & sacred", "Gold & Heiligtum", "ทองคำและสิ่งศักดิ์สิทธิ์", "黄金と聖域");
  E("City & architecture", "Stadt & Architektur", "เมืองและสถาปัตยกรรม", "街と建築");
  E("Mekong & evening", "Mekong & Abend", "แม่น้ำโขงและยามเย็น", "メコンと夕暮れ");
  E("Beyond the centre", "Jenseits des Zentrums", "นอกใจกลางเมือง", "郊外へ");
  E("The great golden stupa is the national symbol of Laos — about 3.5 kilometres from the centre, its gilded spire visible long before you arrive.", "Die große goldene Stupa ist das Nationalsymbol von Laos — etwa 3,5 Kilometer vom Zentrum entfernt, ihre vergoldete Spitze schon von Weitem sichtbar.", "พระธาตุหลวงองค์ทองคำคือสัญลักษณ์ประจำชาติลาว ห่างจากใจกลางเมืองราว 3.5 กิโลเมตร ยอดปิดทองมองเห็นได้แต่ไกลก่อนถึง", "黄金の大仏塔はラオスの国の象徴——中心部から約3.5キロ、金色の尖塔は着く前から遠くに輝いて見えます。");
  E("Give it an unhurried hour: the cloistered courtyard, the reclining Buddha beside the stupa, and gold that shifts with every change of light.", "Nehmt euch eine ruhige Stunde: der Kreuzgang-Hof, der liegende Buddha neben der Stupa und Gold, das sich mit jedem Licht verändert.", "ให้เวลาสักชั่วโมงแบบไม่เร่งรีบ ลานระเบียงคด พระนอนข้างองค์พระธาตุ และสีทองที่เปลี่ยนไปตามแสง", "ゆっくり1時間を——回廊の中庭、仏塔の傍らの寝釈迦仏、光とともに移ろう黄金を。");
  E("Vientiane's triumphal arch — palm-lined, unhurried, and worth the climb for the view down the avenue.", "Vientianes Triumphbogen — von Palmen gesäumt, gelassen, und der Aufstieg lohnt für den Blick die Prachtstraße hinab.", "ประตูชัยแห่งเวียงจันทน์ — แนวต้นปาล์ม บรรยากาศสบาย และคุ้มค่าที่จะขึ้นไปชมวิวตลอดแนวถนนใหญ่", "ビエンチャンの凱旋門——椰子並木に囲まれ、ゆったりと。登れば大通りを見渡す眺めが待っています。");
  E("Raised in the late 1950s and 1960s, the arch answers Paris with Lao form — naga finials, lotus mouldings and a crown of five towers above the city’s grandest avenue.", "In den späten 1950er- und 1960er-Jahren errichtet, antwortet der Bogen Paris mit laotischer Form — Naga-Zierspitzen, Lotus-Ornamente und eine Krone aus fünf Türmen über der größten Prachtstraße der Stadt.", "สร้างขึ้นช่วงปลายทศวรรษ 1950 ถึง 1960 ซุ้มประตูนี้ตอบปารีสด้วยรูปแบบลาว — ยอดพญานาค ลายดอกบัว และมงกุฎห้ายอดเหนือถนนสายใหญ่ที่สุดของเมือง", "1950年代末から60年代に建てられたこの門は、パリにラオスの様式で応えます——ナーガの尖飾、蓮の装飾、そして市随一の大通りに立つ五つの塔の冠。");
  E("Climb it: the upper terraces look straight over the fountain park and down Lane Xang Avenue — our second photograph is that view. Morning and late afternoon bring the kindest light.", "Steigt hinauf: Die oberen Terrassen blicken direkt über den Brunnenpark und die Lane-Xang-Avenue hinab — unser zweites Foto zeigt genau diesen Blick. Morgens und am späten Nachmittag ist das Licht am schönsten.", "ขึ้นไปชมได้ ระเบียงชั้นบนมองตรงเหนือสวนน้ำพุและตลอดถนนล้านช้าง — ภาพที่สองของเราคือวิวนั้น แสงงามที่สุดยามเช้าและบ่ายแก่", "上ってみてください。上層テラスからは噴水公園とラーンサーン大通りを一望——2枚目の写真がその眺めです。朝と夕方前の光が最も優しく。");
  E("Every evening the red-roofed stalls open along Chao Anouvong Park — clothes, crafts and small food, with the Mekong turning to colour behind them.", "Jeden Abend öffnen die rot gedeckten Stände entlang des Chao-Anouvong-Parks — Kleidung, Kunsthandwerk und kleine Gerichte, während der Mekong dahinter Farbe annimmt.", "ทุกเย็นแผงค้าหลังคาแดงเปิดเรียงรายตามสวนเจ้าอนุวงศ์ — เสื้อผ้า งานฝีมือ และของกินเล็ก ๆ ขณะแม่น้ำโขงเบื้องหลังเปลี่ยนเป็นสีสัน", "毎夕、チャオ・アヌウォン公園沿いに赤い屋根の屋台が開きます——衣類や工芸、小さな食べ物。その向こうでメコンが色づいていきます。");
  E("Come for the promenade as much as the market: at sunset the riverfront fills with families, runners and food carts, and the far bank is already Thailand.", "Kommt ebenso für die Promenade wie für den Markt: Bei Sonnenuntergang füllt sich das Ufer mit Familien, Läufern und Essenswagen — und das andere Ufer ist schon Thailand.", "มาเพื่อลานริมน้ำพอ ๆ กับตลาด ยามอาทิตย์ตกริมฝั่งเต็มไปด้วยครอบครัว นักวิ่ง และรถเข็นขายอาหาร ฝั่งตรงข้ามคือประเทศไทยแล้ว", "市場と同じくらい遊歩道も目当てに——日暮れの川辺は家族連れやランナー、屋台でにぎわい、対岸はもうタイです。");
  E("The oldest temple in Vientiane — thousands of Buddhas in a quiet cloister that survived when the city did not.", "Der älteste Tempel Vientianes — Tausende Buddhas in einem stillen Kreuzgang, der überstand, was die Stadt nicht überstand.", "วัดที่เก่าแก่ที่สุดในเวียงจันทน์ — พระพุทธรูปนับพันในระเบียงคดอันเงียบสงบที่รอดมาได้แม้เมืองไม่รอด", "ビエンチャン最古の寺院——街が失われたときも残った静かな回廊に、幾千もの仏像が並びます。");
  E("The only temple left standing after the siege of 1827, its cloister walls hold niche after niche of Buddha figures — photography stays outside the ordination hall.", "Als einziger Tempel überstand er die Belagerung von 1827; seine Kreuzgangmauern bergen Nische um Nische mit Buddhafiguren — fotografiert wird nur außerhalb der Ordinationshalle.", "วัดเดียวที่ยังคงอยู่หลังศึกปี 1827 ผนังระเบียงคดเรียงรายด้วยช่องพระพุทธรูปนับไม่ถ้วน — งดถ่ายภาพภายในสิม", "1827年の包囲戦を唯一生き延びた寺院。回廊の壁には無数の壁龕に仏像が収められています——本堂内は撮影禁止です。");
  E("Vientiane's most beloved working temple — colour, incense and the shrine of the city pillar.", "Vientianes beliebtester lebendiger Tempel — Farbe, Weihrauch und der Schrein der Stadtsäule.", "วัดที่ชาวเวียงจันทน์รักที่สุด — สีสัน ธูปหอม และศาลหลักเมือง", "ビエンチャンで最も愛される現役の寺院——色彩と線香、そして市の柱の祠。");
  E("This is where Vientiane itself comes to pray — marigolds, daily blessings and the city pillar shrine, a short walk from Wat Si Saket.", "Hierher kommt Vientiane selbst zum Beten — Ringelblumen, tägliche Segnungen und der Stadtsäulen-Schrein, nur einen kurzen Spaziergang vom Wat Si Saket entfernt.", "ที่นี่คือที่ที่ชาวเวียงจันทน์มาไหว้พระ — ดอกดาวเรือง พิธีให้พรประจำวัน และศาลหลักเมือง เดินไม่ไกลจากวัดสีสะเกด", "ここはビエンチャンの人々自身が祈りに来る場所——マリーゴールド、日々の祈祷、市の柱の祠。ワット・シーサケートから歩いてすぐです。");
  E("The former royal temple built for the Emerald Buddha — now a calm museum of Lao Buddhist art.", "Der einstige Königstempel, erbaut für den Smaragd-Buddha — heute ein ruhiges Museum laotischer buddhistischer Kunst.", "อดีตวัดหลวงที่สร้างขึ้นเพื่อพระแก้วมรกต — ปัจจุบันเป็นพิพิธภัณฑ์อันสงบของพุทธศิลป์ลาว", "エメラルド仏のために建てられたかつての王室寺院——今はラオス仏教美術の静かな博物館です。");
  E("The Emerald Buddha itself left for Bangkok centuries ago; what remains is a garden, a carved terrace and one of the country’s finest collections of Buddha figures.", "Der Smaragd-Buddha selbst ging vor Jahrhunderten nach Bangkok; geblieben sind ein Garten, eine geschnitzte Terrasse und eine der schönsten Buddhafiguren-Sammlungen des Landes.", "พระแก้วมรกตเสด็จไปกรุงเทพฯ เมื่อหลายศตวรรษก่อน สิ่งที่เหลือคือสวน ระเบียงแกะสลัก และหนึ่งในคอลเลกชันพระพุทธรูปที่งดงามที่สุดของประเทศ", "エメラルド仏そのものは数世紀前にバンコクへ。残るのは庭園と彫刻のテラス、そして国内屈指の仏像コレクションです。");
  E("French-colonial grandeur behind gilded gates — best admired from the avenue.", "Französisch-koloniale Grandezza hinter vergoldeten Toren — am schönsten von der Prachtstraße aus zu bewundern.", "ความสง่างามแบบอาณานิคมฝรั่งเศสหลังประตูปิดทอง — ชมได้งามที่สุดจากถนนใหญ่", "金色の門の向こうのフランス植民地様式の威容——大通りから眺めるのがいちばんです。");
  E("The palace is not open to visitors, and doesn’t need to be — it reads best from outside the fence, palms and flag above the white façade, with Ha Phrakeo directly next door.", "Der Palast ist nicht für Besucher geöffnet — und muss es auch nicht sein: Am besten wirkt er von außerhalb des Zauns, Palmen und Flagge über der weißen Fassade, mit dem Ha Phrakeo direkt nebenan.", "พระราชวังไม่เปิดให้เข้าชม และก็ไม่จำเป็น — งามที่สุดเมื่อมองจากนอกรั้ว ต้นปาล์มและธงเหนืออาคารสีขาว โดยมีหอพระแก้วอยู่ติดกัน", "宮殿は非公開ですが、それで十分——柵の外から、白いファサードの上の椰子と旗を眺めるのが最も美しい。隣はハ・プラケオです。");
  E("The Black Stupa — centuries of quiet legend holding a city roundabout.", "Die Schwarze Stupa — Jahrhunderte stiller Legenden mitten in einem Kreisverkehr der Stadt.", "พระธาตุดำ — ตำนานเงียบงันหลายศตวรรษกลางวงเวียนเมือง", "ブラック・ストゥーパ——街のロータリーに佇む、幾世紀もの静かな伝説。");
  E("Unrestored and slightly overgrown, it stands mid-roundabout among cafés and embassies — a five-minute pause that feels older than everything around it.", "Unrestauriert und leicht überwachsen steht sie mitten im Kreisverkehr zwischen Cafés und Botschaften — eine Fünf-Minuten-Pause, die älter wirkt als alles um sie herum.", "ไม่ได้บูรณะและมีต้นไม้ขึ้นปกคลุมเล็กน้อย ตั้งอยู่กลางวงเวียนท่ามกลางคาเฟ่และสถานทูต — ห้านาทีแห่งการหยุดพักที่รู้สึกเก่าแก่กว่าทุกสิ่งรอบตัว", "修復されず、少し草に覆われたまま、カフェや大使館に囲まれたロータリーの中央に——周囲の何よりも古く感じられる、5分の小さな寄り道です。");
  E("A riverside sculpture garden of giants, about an hour from the city.", "Ein Skulpturengarten der Riesen am Flussufer, etwa eine Stunde von der Stadt entfernt.", "สวนประติมากรรมยักษ์ริมแม่น้ำ ห่างจากตัวเมืองราวหนึ่งชั่วโมง", "川辺に広がる巨像の彫刻庭園——市内から約1時間です。");
  E("Some twenty kilometres downstream, Hindu and Buddhist figures crowd a green meadow — the great reclining Buddha above all. An easy half-day escape, and a favourite with children.", "Rund zwanzig Kilometer flussabwärts drängen sich hinduistische und buddhistische Figuren auf einer grünen Wiese — allen voran der große liegende Buddha. Ein einfacher Halbtagesausflug, bei Kindern besonders beliebt.", "ราวยี่สิบกิโลเมตรตามลำน้ำ รูปปั้นฮินดูและพุทธเรียงรายบนทุ่งหญ้าเขียว — โดดเด่นที่สุดคือพระนอนองค์ใหญ่ เที่ยวครึ่งวันแบบสบาย ๆ และเด็ก ๆ ชอบเป็นพิเศษ", "川を約20キロ下ると、緑の草地にヒンドゥーと仏教の像がひしめきます——ひときわ大きいのは巨大な寝釈迦仏。気軽な半日の遠出で、子どもたちにも人気です。");
  /* Sacred Morning Ritual — personal offering (owner order 05 Sep 2026) */
  E("Sacred Morning Ritual", "Heiliges Morgenritual", "พิธีศักดิ์สิทธิ์ยามเช้า", "神聖な朝の儀式");
  E("Alms Giving · Tak Bat", "Almosengabe · Tak Bat", "การตักบาตร · ตักบาตร", "托鉢 · タクバート");
  E("First light", "Erstes Licht", "แสงแรกของวัน", "夜明けの光");
  E("The Offering", "Die Opfergabe", "เครื่องไทยธรรม", "お供え");
  E("Ceremony", "Zeremonie", "พิธี", "儀式");
  E("Ceremony — part of the wedding morning · complimentary.", "Zeremonie — Teil des Hochzeitsmorgens · ohne Kosten.", "พิธี — เป็นส่วนหนึ่งของเช้าวันแต่งงาน · ไม่มีค่าใช้จ่าย", "儀式——結婚式の朝の一部・費用はかかりません。");
  E("For those who wish to take part in the alms-giving itself, we will prepare an individual offering for you in advance.", "Wenn ihr persönlich an der Almosengabe teilnehmen möchtet, bereiten wir eure individuelle Opfergabe im Voraus für euch vor.", "สำหรับผู้ที่ต้องการร่วมตักบาตรด้วยตนเอง เราจะเตรียมเครื่องไทยธรรมส่วนบุคคลไว้ให้ล่วงหน้า", "托鉢に自らご参加されたい方には、お一人ずつのお供えを事前にご用意いたします。");
  E("Offering contribution · USD 15 per participant", "Opfergaben-Beitrag · USD 15 pro teilnehmender Person", "ค่าเครื่องไทยธรรม · USD 15 ต่อผู้ร่วมพิธีหนึ่งท่าน", "お供えの奉納 · おひとり15米ドル");
  E("In Lao Buddhist tradition, the offering is a personal act of giving and merit-making. For that reason, it should come from the person who presents it rather than from the hosts.", "In der laotisch-buddhistischen Tradition ist die Opfergabe ein persönlicher Akt des Gebens und des Verdiensterwerbs. Deshalb soll die Gabe von der Person selbst kommen, die sie überreicht — nicht von den Gastgebern.", "ในประเพณีพุทธแบบลาว เครื่องไทยธรรมคือการให้และการทำบุญส่วนบุคคล ด้วยเหตุนี้ของถวายจึงควรมาจากผู้ถวายเอง มิใช่จากเจ้าภาพ", "ラオスの仏教の伝統では、お供えは自ら行う布施と徳積みの行いです。そのため、お供えは主催者からではなく、捧げる本人から出るものとされています。");
  E("If tradition allowed us to cover this for you, we would gladly do so. Here, the personal contribution is part of the meaning of the ritual itself.", "Wenn es die Tradition erlauben würde, würden wir diese Kosten selbstverständlich gerne für euch übernehmen. Hier jedoch ist der persönliche Beitrag Teil der Bedeutung des Rituals selbst.", "หากประเพณีเอื้อให้เราจัดเตรียมแทนได้ เรายินดีทำให้ด้วยความเต็มใจ แต่ในพิธีนี้ การถวายด้วยตนเองคือส่วนหนึ่งของความหมายของพิธีเอง", "伝統が許すのであれば、私たちが喜んで負担いたします。しかしこの儀式では、本人による奉納こそが儀式の意味の一部なのです。");
  E("Please reserve your offering in advance so that we can prepare the correct number for the morning.", "Bitte reserviert eure Opfergabe vorab, damit wir die richtige Anzahl für den Morgen vorbereiten können.", "กรุณาจองเครื่องไทยธรรมล่วงหน้า เพื่อให้เราเตรียมจำนวนได้ถูกต้องสำหรับเช้าวันนั้น", "朝に正しい数をご用意できるよう、お供えは事前にご予約ください。");
  E("Reserve your offering", "Opfergabe reservieren", "จองเครื่องไทยธรรม", "お供えを予約する");
  E("Offering reserved", "Opfergabe reserviert", "จองเครื่องไทยธรรมแล้ว", "お供え予約済み");
  E("The personal offering baskets, prepared for the morning", "Die persönlichen Opfergaben-Körbe, vorbereitet für den Morgen", "ตะกร้าเครื่องไทยธรรมส่วนบุคคล เตรียมพร้อมสำหรับยามเช้า", "朝のために用意された、お一人ずつのお供えかご");
  E("Tak Bat — also called Sai Bat — is the traditional Lao morning alms-giving. At dawn, monks leave their temples and walk silently in line with their alms bowls while people wait along the route and place sticky rice, fruit and small food into the bowls. It is a living religious tradition, not a staged attraction — a daily bond between the community and the monastic order.", "Tak Bat — auch Sai Bat genannt — ist die traditionelle laotische Almosengabe am Morgen. Bei Tagesanbruch verlassen die Mönche schweigend in einer Reihe ihre Tempel, während die Menschen am Weg warten und Klebreis, Obst und kleine Speisen in die Almosenschalen legen. Es ist eine gelebte religiöse Tradition, keine Inszenierung — ein tägliches Band zwischen Gemeinschaft und Mönchsorden.", "ตักบาตร หรือใส่บาตร คือประเพณีถวายอาหารยามเช้าแบบลาว เมื่อรุ่งสางพระสงฆ์เดินเรียงแถวออกจากวัดอย่างเงียบงัน ขณะผู้คนรออยู่ริมทางเพื่อใส่ข้าวเหนียว ผลไม้ และอาหารเล็กน้อยลงในบาตร นี่คือประเพณีทางศาสนาที่มีชีวิต มิใช่การแสดง แต่เป็นสายใยประจำวันระหว่างชุมชนกับคณะสงฆ์", "タクバート（サイバートとも）は、ラオスの伝統的な朝の托鉢です。夜明けに僧侶たちは鉢を携え、静かに列をなして寺を出ます。人々は道端で待ち、もち米や果物、小さな食べ物を鉢に納めます。これは演出された観光ではなく、今も生きる宗教の伝統——地域と僧団を結ぶ日々の絆です。");
  E("Giving is understood as merit-making: the material gift carries the spiritual dimension of humility, respect and mindfulness with it.", "Das Geben gilt als Verdiensterwerb: Die materielle Gabe trägt die geistige Dimension von Demut, Respekt und Achtsamkeit in sich.", "การให้คือการทำบุญ ของถวายทางวัตถุจึงมาพร้อมมิติทางจิตใจแห่งความอ่อนน้อม ความเคารพ และสติ", "布施は徳積みとされ、形あるお供えには謙虚さ、敬意、心を込めるという精神的な意味が宿ります。");
  E("Respecting the ritual", "Respekt vor dem Ritual", "การเคารพต่อพิธี", "儀式への敬意");
  E("Dress modestly.", "Kleidet euch zurückhaltend.", "แต่งกายสุภาพเรียบร้อย", "肌の露出を控えた装いで。");
  E("Remain quiet and arrive before the monks.", "Bleibt still und seid vor den Mönchen da.", "อยู่ในความเงียบและมาถึงก่อนพระสงฆ์", "静粛に、僧侶の到着前にお越しください。");
  E("Follow local guidance.", "Folgt der Anleitung vor Ort.", "ปฏิบัติตามคำแนะนำของท้องถิ่น", "現地の案内に従ってください。");
  E("Sit or kneel lower than the monks when presenting your offering.", "Sitzt oder kniet beim Überreichen der Gabe tiefer als die Mönche.", "นั่งหรือคุกเข่าให้ต่ำกว่าพระสงฆ์ขณะถวาย", "お供えを捧げる際は、僧侶より低く座るかひざまずいてください。");
  E("Never touch the monks — women should take particular care to avoid any physical contact.", "Berührt die Mönche niemals — Frauen sollten besonders darauf achten, jeden Körperkontakt zu vermeiden.", "ห้ามแตะต้องพระสงฆ์ — สุภาพสตรีพึงระมัดระวังเป็นพิเศษไม่ให้สัมผัสพระสงฆ์", "僧侶には決して触れないでください——特に女性は、いかなる接触も避けるようご注意ください。");
  E("Do not block or follow the procession.", "Versperrt der Prozession nicht den Weg und folgt ihr nicht.", "อย่าขวางหรือเดินตามขบวนพระ", "行列を遮ったり、後を追ったりしないでください。");
  E("No flash photography.", "Kein Blitzlicht.", "งดใช้แฟลชถ่ายภาพ", "フラッシュ撮影はご遠慮ください。");
  E("Participate respectfully rather than treating the ritual as a photo opportunity.", "Nehmt respektvoll teil, statt das Ritual als Fotomotiv zu behandeln.", "ร่วมพิธีด้วยความเคารพ มิใช่มองพิธีเป็นเพียงโอกาสถ่ายภาพ", "写真の機会としてではなく、敬意をもってご参加ください。");
  E("Personal offerings · Sacred Morning Ritual", "Persönliche Opfergaben · Heiliges Morgenritual", "เครื่องไทยธรรมส่วนบุคคล · พิธีศักดิ์สิทธิ์ยามเช้า", "お一人ずつのお供え · 神聖な朝の儀式");
  E("The wedding day begins with the Sacred Morning Ritual — the Lao alms giving, Tak Bat. At dawn, monks walk silently in line with their alms bowls while those taking part kneel along the route and place sticky rice and small food into the bowls. It is a living religious tradition, not a staged attraction — a quiet daily bond between the community and the monastic order.", "Der Hochzeitstag beginnt mit dem Heiligen Morgenritual — der laotischen Almosengabe, Tak Bat. Bei Tagesanbruch gehen die Mönche schweigend in einer Reihe mit ihren Almosenschalen, während die Teilnehmenden am Weg knien und Klebreis und kleine Speisen in die Schalen legen. Es ist eine gelebte religiöse Tradition, keine Inszenierung — ein stilles tägliches Band zwischen Gemeinschaft und Mönchsorden.", "วันแต่งงานเริ่มต้นด้วยพิธีศักดิ์สิทธิ์ยามเช้า — การตักบาตรแบบลาว เมื่อรุ่งสางพระสงฆ์เดินเรียงแถวอย่างเงียบงันพร้อมบาตร ขณะผู้ร่วมพิธีคุกเข่าริมทางใส่ข้าวเหนียวและอาหารเล็กน้อยลงในบาตร นี่คือประเพณีทางศาสนาที่มีชีวิต มิใช่การแสดง แต่เป็นสายใยอันเงียบสงบระหว่างชุมชนกับคณะสงฆ์", "結婚式の一日は神聖な朝の儀式——ラオスの托鉢、タクバートで始まります。夜明けに僧侶たちは鉢を携えて静かに列をなして歩き、参加者は道端にひざまずいて、もち米や小さな食べ物を鉢に納めます。これは演出ではなく、今も生きる宗教の伝統——地域と僧団を結ぶ静かな日々の絆です。");
  E("For guests who wish to make an offering themselves, an individual offering is prepared in advance and reserved in the Guest Area. In Lao Buddhist tradition the offering is a personal act of giving and merit-making — it comes from the person who presents it rather than from the hosts; the personal contribution is part of the meaning of the ritual itself.", "Für Gäste, die selbst eine Gabe überreichen möchten, wird eine individuelle Opfergabe im Voraus vorbereitet und im Gästebereich reserviert. In der laotisch-buddhistischen Tradition ist die Opfergabe ein persönlicher Akt des Gebens und des Verdiensterwerbs — sie kommt von der Person, die sie überreicht, nicht von den Gastgebern; der persönliche Beitrag ist Teil der Bedeutung des Rituals selbst.", "สำหรับแขกที่ต้องการถวายด้วยตนเอง จะมีการเตรียมเครื่องไทยธรรมส่วนบุคคลไว้ล่วงหน้าและจองได้ในพื้นที่สำหรับแขก ในประเพณีพุทธแบบลาว เครื่องไทยธรรมคือการให้และการทำบุญส่วนบุคคล — มาจากผู้ถวายเอง มิใช่จากเจ้าภาพ การถวายด้วยตนเองคือส่วนหนึ่งของความหมายของพิธี", "ご自身でお供えを捧げたいゲストのために、お一人ずつのお供えを事前にご用意し、ゲストエリアでご予約いただけます。ラオスの仏教の伝統では、お供えは自ら行う布施と徳積みの行い——主催者からではなく、捧げる本人から出るものであり、本人による奉納こそが儀式の意味の一部です。");
  E("The wedding day then continues at Wat Ong Teu Temple in Vientiane: a Buddhist morning ceremony from nine until around midday, unhurried and full of meaning. Afterwards we return together to the hotel for coffee & cake before the vows.", "Danach geht der Hochzeitstag im Wat Ong Teu Tempel in Vientiane weiter: eine buddhistische Morgenzeremonie von neun bis gegen Mittag, gelassen und voller Bedeutung. Anschließend kehren wir gemeinsam ins Hotel zurück — zu Kaffee & Kuchen vor dem Eheversprechen.", "จากนั้นวันแต่งงานดำเนินต่อที่วัดองค์ตื้อ นครเวียงจันทน์ พิธีสงฆ์ยามเช้าตั้งแต่เก้าโมงถึงราวเที่ยง เรียบง่ายและเปี่ยมความหมาย แล้วเรากลับโรงแรมด้วยกันเพื่อกาแฟและเค้กก่อนพิธีกล่าวคำสัญญา", "その後、結婚式の一日はビエンチャンのワット・オントゥー寺院へ——九時から正午頃まで、ゆったりと意味に満ちた仏教の朝の儀式が続きます。その後は皆でホテルへ戻り、誓いの前のコーヒーとケーキの時間を過ごします。");
  E("The wedding day begins at first light with the Lao alms giving — Tak Bat — then continues with the Buddhist morning ceremony at Wat Ong Teu Temple.", "Der Hochzeitstag beginnt beim ersten Licht mit der laotischen Almosengabe — Tak Bat — und geht dann mit der buddhistischen Morgenzeremonie im Wat Ong Teu Tempel weiter.", "วันแต่งงานเริ่มต้นเมื่อแสงแรกของวันด้วยการตักบาตรแบบลาว แล้วต่อด้วยพิธีสงฆ์ยามเช้าที่วัดองค์ตื้อ", "結婚式の一日は夜明けの光とともにラオスの托鉢——タクバートで始まり、ワット・オントゥー寺院での仏教の朝の儀式へと続きます。");
  E("Monks walking in line at dawn during the alms giving", "Mönche in einer Reihe bei der Almosengabe im Morgengrauen", "พระสงฆ์เดินเรียงแถวยามรุ่งสางระหว่างการตักบาตร", "夜明けの托鉢で列をなして歩く僧侶たち");
  /* travel-portal shell (owner reset order, 05 Sep 2026) */
  E("Explore", "Entdecken", "สำรวจ", "見る");
  E("Experience details", "Erlebnis-Details", "รายละเอียดสถานที่", "スポットの詳細");
  E("Open", "Öffnen", "เปิด", "開く");
  E("Journey", "Reise", "การเดินทาง", "旅");
  E("Wedding", "Hochzeit", "งานแต่งงาน", "結婚式");
  E("Places", "Orte", "สถานที่", "スポット");
  E("← Our Journey", "← Unsere Reise", "← เส้นทางของเรา", "← 私たちの旅");
  E("Join this chapter", "Dieses Kapitel dazunehmen", "เข้าร่วมช่วงการเดินทางนี้", "この章に参加する");
  E("Not this time — leave this chapter", "Diesmal nicht — Kapitel verlassen", "ครั้งนี้ขอผ่าน — ออกจากช่วงนี้", "今回は見送る——この章から外れる");
  E("The Wedding Morning", "Der Hochzeitsmorgen", "เช้าวันแต่งงาน", "結婚式の朝");
  E("Vow Ceremony", "Eheversprechen", "พิธีกล่าวคำสัญญา", "誓いのセレモニー");
  E("Journey to Vientiane", "Reise nach Vientiane", "เดินทางสู่เวียงจันทน์", "ビエンチャンへの旅");
  E("Places to Explore", "Orte zum Entdecken", "สถานที่น่าสำรวจ", "訪ねたいスポット");
  E("Places in Vientiane", "Orte in Vientiane", "สถานที่ในเวียงจันทน์", "ビエンチャンのスポット");
  E("Your Stay & Onward Travel", "Eure Unterkunft & Weiterreise", "ที่พักและการเดินทางต่อ", "滞在と移動");
  E("Your Stay", "Eure Unterkunft", "ที่พักของคุณ", "ご滞在");
  E("Cherry Blossom", "Kirschblüte", "ซากุระบาน", "桜");
  E("Review & Send", "Prüfen & Senden", "ตรวจสอบและส่ง", "確認して送信");
  E("One quiet look, then send", "Ein ruhiger Blick, dann absenden", "ตรวจดูอีกครั้ง แล้วกดส่ง", "静かに見直してから送信");
  E("With Guest Relations", "Bei Guest Relations", "อยู่กับ Guest Relations แล้ว", "ゲストリレーションズにて対応中");
  E("Complete", "Vollständig", "ครบถ้วน", "完了");
  E("Swipe · tap a place to open it", "Wischen · einen Ort antippen, um ihn zu öffnen", "ปัดดู · แตะสถานที่เพื่อเปิด", "スワイプ · タップで開く");
  E("Tap a photo to view all photos", "Ein Foto antippen, um alle Fotos zu sehen", "แตะภาพเพื่อดูภาพทั้งหมด", "写真をタップすると全て見られます");
  E("Places for this chapter follow soon.", "Orte für dieses Kapitel folgen bald.", "สถานที่สำหรับช่วงนี้จะตามมาเร็ว ๆ นี้", "この章のスポットは近日追加されます。");
  E("A travel guide through the journey — tap a place to open it. Nothing here is a booking.", "Ein Reiseführer durch die Reise — einen Ort antippen, um ihn zu öffnen. Nichts hiervon ist eine Buchung.", "คู่มือการเดินทาง — แตะสถานที่เพื่อเปิดดู ทั้งหมดนี้ไม่ใช่การจอง", "旅のガイド——タップして開けます。ここに予約はありません。");
  E("Bangkok — Wat Pho mirrored after the rain", "Bangkok — Wat Pho, gespiegelt nach dem Regen", "กรุงเทพฯ — วัดโพธิ์สะท้อนเงาหลังฝน", "バンコク——雨上がりに映るワット・ポー");
  E("Lijiang — Black Dragon Pool beneath Jade Dragon Snow Mountain", "Lijiang — der Schwarze-Drachen-Teich unter dem Jadedrachen-Schneeberg", "ลี่เจียง — สระมังกรดำใต้ภูเขาหิมะมังกรหยก", "麗江——玉龍雪山を望む黒龍潭");
  /* public journey chapters (final rebuild) */
  E("four chapters.", "vier Kapiteln.", "สี่บท", "四つの章。");
  E("One journey,", "Eine Reise,", "หนึ่งการเดินทาง", "ひとつの旅、");
  E("Journey chapters", "Reisekapitel", "บทของการเดินทาง", "旅の章");
  E("Before the Wedding · Optional", "Vor der Hochzeit · Optional", "ก่อนงานแต่งงาน · ตามอัธยาศัย", "結婚式の前に · 任意");
  E("The Wedding · Heart of the Journey", "Die Hochzeit · Herz der Reise", "งานแต่งงาน · หัวใจของการเดินทาง", "結婚式 · 旅の中心");
  E("After the Wedding · Optional", "Nach der Hochzeit · Optional", "หลังงานแต่งงาน · ตามอัธยาศัย", "結婚式の後に · 任意");
  E("Four chapters carry the journey: the shared days in Bangkok, the wedding in Vientiane, and the quiet epilogue through Kunming and Lijiang. Open a chapter — everything else stays out of the way.", "Vier Kapitel tragen die Reise: die gemeinsamen Tage in Bangkok, die Hochzeit in Vientiane und der stille Epilog durch Kunming und Lijiang. Öffnet ein Kapitel — alles andere bleibt ruhig im Hintergrund.", "สี่บทของการเดินทาง วันเวลาร่วมกันในกรุงเทพฯ งานแต่งงานที่เวียงจันทน์ และบทส่งท้ายอันเงียบสงบผ่านคุนหมิงและลี่เจียง เปิดดูทีละบท ส่วนอื่นจะรออยู่เงียบ ๆ", "旅は四つの章で紡がれます——バンコクでの日々、ビエンチャンでの結婚式、昆明と麗江への静かなエピローグ。章を開けば、他はそっと控えています。");
  E("BKK", "BKK", "BKK", "BKK");
  E("VTE", "VTE", "VTE", "VTE");
  E("KMG", "KMG", "KMG", "KMG");
  E("LJG", "LJG", "LJG", "LJG");
  /* fixed public architecture (owner final UX correction, 05 Sep 2026) */
  E("The Journey at a Glance", "Die Reise auf einen Blick", "ภาพรวมการเดินทาง", "旅の全体像");
  E("The journey", "Die Reise", "การเดินทาง", "旅の");
  E("at a glance.", "auf einen Blick.", "ในหนึ่งภาพ", "全体像。");
  E("03 · Before the Wedding", "03 · Vor der Hochzeit", "03 · ก่อนงานแต่งงาน", "03 · 結婚式の前に");
  E("04 · The Wedding", "04 · Die Hochzeit", "04 · งานแต่งงาน", "04 · 結婚式");
  E("05 · After the Wedding", "05 · Nach der Hochzeit", "05 · หลังงานแต่งงาน", "05 · 結婚式の後に");
  E("Good to Know", "Gut zu wissen", "ควรรู้", "お役立ち情報");
  E("The quiet", "Die stillen", "สิ่งจำเป็น", "静かな");
  E("essentials.", "Essentials.", "อันเงียบง่าย", "基本情報。");
  E("21 – 27 FEB · Thailand → Laos", "21. – 27. FEB · Thailand → Laos", "21 – 27 ก.พ. · ไทย → ลาว", "2月21日–27日 · タイ → ラオス");
  E("21 – 27 FEB 2027 · Thailand → Laos", "21. – 27. FEB 2027 · Thailand → Laos", "21 – 27 ก.พ. 2027 · ไทย → ลาว", "2027年2月21日–27日 · タイ → ラオス");
  E("27 FEB – 01 MAR · Vientiane, Laos", "27. FEB – 01. MÄR · Vientiane, Laos", "27 ก.พ. – 1 มี.ค. · เวียงจันทน์ ลาว", "2月27日–3月1日 · ビエンチャン、ラオス");
  E("01 – 06 MAR · China", "01. – 06. MÄR · China", "1 – 6 มี.ค. · จีน", "3月1日–6日 · 中国");
  E("01 – 06 MAR 2027 · China · optional continuation", "01. – 06. MÄR 2027 · China · optionale Fortsetzung", "1 – 6 มี.ค. 2027 · จีน · ต่อได้ตามอัธยาศัย", "2027年3月1日–6日 · 中国 · 任意の続き");
  E("24 FEB · 20:25", "24. FEB · 20:25", "24 ก.พ. · 20:25", "2月24日 · 20:25");
  E("25 FEB · morning", "25. FEB · morgens", "25 ก.พ. · ยามเช้า", "2月25日 · 朝");
  E("NONG KHAI", "NONG KHAI", "หนองคาย", "ノーンカーイ");
  E("Arrival in Laos", "Ankunft in Laos", "ถึงลาว", "ラオス到着");
  E("The Overnight Journey", "Die Nachtzugreise", "การเดินทางข้ามคืน", "夜行の旅");
  E("Special Express No. 25 · Bangkok → Nong Khai · First Class Sleeper", "Special Express Nr. 25 · Bangkok → Nong Khai · First-Class-Schlafwagen", "รถด่วนพิเศษขบวน 25 · กรุงเทพฯ → หนองคาย · ตู้นอนชั้นหนึ่ง", "特急25号 · バンコク → ノーンカーイ · 一等寝台");
  E("Elegant 6BR Sathorn Penthouse · one shared home", "Elegant 6BR Sathorn Penthouse · ein gemeinsames Zuhause", "Elegant 6BR Sathorn Penthouse · บ้านหลังเดียวกัน", "エレガント6BRサトーン·ペントハウス——皆でひとつの家");
  E("The journey begins together: three Bangkok days in one shared residence — slow mornings, the city in small doses, the table always set for everyone.", "Die Reise beginnt gemeinsam: drei Bangkok-Tage in einer gemeinsamen Residenz — langsame Morgen, die Stadt in kleinen Dosen, der Tisch immer für alle gedeckt.", "การเดินทางเริ่มต้นด้วยกัน สามวันในกรุงเทพฯ ในบ้านพักหลังเดียวกัน เช้าที่เนิบช้า เมืองทีละนิด และโต๊ะอาหารที่พร้อมสำหรับทุกคนเสมอ", "旅は共に始まります。バンコクの3日間をひとつの住まいで——ゆっくりの朝、少しずつの街歩き、いつも皆のための食卓。");
  E("Across the river and into Vientiane — the last quiet stretch before the wedding days begin.", "Über den Fluss und hinein nach Vientiane — das letzte stille Stück, bevor die Hochzeitstage beginnen.", "ข้ามแม่น้ำเข้าสู่เวียงจันทน์ ช่วงสุดท้ายอันเงียบสงบก่อนวันแต่งงานจะเริ่มต้น", "川を渡ってビエンチャンへ——結婚式の日々が始まる前の、最後の静かな道のりです。");
  E("Sunday, 28 February 2027 — one day, carried from first light to the long table, all around one quiet courtyard.", "Sonntag, 28. Februar 2027 — ein Tag, getragen vom ersten Licht bis zur langen Tafel, alles um einen stillen Innenhof.", "วันอาทิตย์ที่ 28 กุมภาพันธ์ 2027 — หนึ่งวันจากแสงแรกจนถึงโต๊ะยาว รอบลานอันเงียบสงบแห่งเดียว", "2027年2月28日（日）——夜明けの光から長いテーブルまで、ひとつの静かな中庭を囲んで紡がれる一日。");
  E("The Sacred Morning Ritual — Tak Bat. Monks walk silently at first light; those taking part kneel along the route with their offerings.", "Das Heilige Morgenritual — Tak Bat. Mönche gehen schweigend im ersten Licht; wer teilnimmt, kniet mit seiner Gabe am Weg.", "พิธีศักดิ์สิทธิ์ยามเช้า — ตักบาตร พระสงฆ์เดินอย่างเงียบงันในแสงแรก ผู้ร่วมพิธีคุกเข่าริมทางพร้อมเครื่องไทยธรรม", "神聖な朝の儀式——タクバート。夜明けの光の中を僧侶が静かに歩き、参加者はお供えを手に道端にひざまずきます。");
  E("A Buddhist morning ceremony until around midday — unhurried and full of meaning.", "Eine buddhistische Morgenzeremonie bis gegen Mittag — gelassen und voller Bedeutung.", "พิธีสงฆ์ยามเช้าจนถึงราวเที่ยง เรียบง่ายและเปี่ยมความหมาย", "正午頃まで続く仏教の朝の儀式——ゆったりと、意味に満ちて。");
  E("The shared home of the wedding days — heritage rooms around one courtyard, breakfast every morning, the second wedding night hosted by Haruthai & Suthep. Rooms are chosen in your Guest Area.", "Das gemeinsame Zuhause der Hochzeitstage — Heritage-Zimmer um einen Innenhof, jeden Morgen Frühstück, die zweite Hochzeitsnacht von Haruthai & Suthep übernommen. Die Zimmer wählt ihr im Gästebereich.", "บ้านของวันแต่งงาน ห้องพักเฮอริเทจรอบลานเดียวกัน อาหารเช้าทุกวัน คืนที่สองของงานแต่งงานเป็นเจ้าภาพโดยหฤทัยและสุเทพ เลือกห้องได้ในพื้นที่สำหรับแขก", "結婚式の日々を過ごす共有の住まい——中庭を囲むヘリテージルーム、毎朝の朝食、2泊目はハルタイとステープがご招待。お部屋はゲストエリアで選べます。");
  E("Explore the stay", "Die Unterkunft entdecken", "ชมที่พัก", "滞在先を見る");
  E("View the morning", "Den Morgen ansehen", "ชมยามเช้า", "朝を見る");
  E("View the ceremony", "Die Zeremonie ansehen", "ชมพิธี", "儀式を見る");
  E("View the vow", "Das Versprechen ansehen", "ชมคำสัญญา", "誓いを見る");
  E("View the evening", "Den Abend ansehen", "ชมยามค่ำ", "夜を見る");
  E("View complete dress guide", "Kompletten Dress Guide ansehen", "ดูคู่มือการแต่งกายฉบับเต็ม", "ドレスガイド全体を見る");
  E("Places to explore · Bangkok", "Orte zum Entdecken · Bangkok", "สถานที่น่าสำรวจ · กรุงเทพฯ", "訪ねたいスポット · バンコク");
  E("Places to explore · Kunming", "Orte zum Entdecken · Kunming", "สถานที่น่าสำรวจ · คุนหมิง", "訪ねたいスポット · 昆明");
  E("The epilogue begins in Yunnan — gardens, spring light and, with luck, the first cherry blossom.", "Der Epilog beginnt in Yunnan — Gärten, Frühlingslicht und mit etwas Glück die erste Kirschblüte.", "บทส่งท้ายเริ่มที่ยูนนาน สวน แสงฤดูใบไม้ผลิ และหากโชคดี ซากุระแรกบาน", "エピローグは雲南から——庭園と春の光、そして運が良ければ最初の桜。");
  E("The last chapter — the old town beneath Jade Dragon Snow Mountain, before the journey turns for home.", "Das letzte Kapitel — die Altstadt unter dem Jadedrachen-Schneeberg, bevor die Reise heimwärts dreht.", "บทสุดท้าย เมืองเก่าใต้ภูเขาหิมะมังกรหยก ก่อนการเดินทางจะมุ่งหน้ากลับบ้าน", "最後の章——玉龍雪山の麓の旧市街。やがて旅は家路へ向かいます。");
  E("Late February · dry season", "Ende Februar · Trockenzeit", "ปลายกุมภาพันธ์ · ฤดูแล้ง", "2月下旬 · 乾季");
  E("Entry & Visa", "Einreise & Visum", "การเข้าเมืองและวีซ่า", "入国とビザ");
  E("Passport-dependent", "Abhängig vom Pass", "ขึ้นอยู่กับหนังสือเดินทาง", "パスポートによる");
  E("Entry requirements for Thailand, Laos and China depend on your passport. Guest Relations checks your route with you personally — nothing to research alone.", "Die Einreisebestimmungen für Thailand, Laos und China hängen von eurem Pass ab. Guest Relations prüft eure Route persönlich mit euch — nichts müsst ihr allein recherchieren.", "ข้อกำหนดการเข้าเมืองของไทย ลาว และจีนขึ้นอยู่กับหนังสือเดินทางของคุณ Guest Relations จะตรวจสอบเส้นทางกับคุณเป็นการส่วนตัว ไม่ต้องค้นหาเองเลย", "タイ・ラオス・中国の入国要件はパスポートによって異なります。ゲストリレーションズがおひとりずつルートを確認します——ご自身で調べる必要はありません。");
  E("The journey travels overnight by First Class Sleeper to Nong Khai, then across the Mekong to Vientiane by coordinated van. Every leg is arranged through your Guest Area.", "Die Reise fährt über Nacht im First-Class-Schlafwagen nach Nong Khai, dann über den Mekong nach Vientiane im koordinierten Van. Jede Etappe wird über euren Gästebereich arrangiert.", "เดินทางข้ามคืนด้วยตู้นอนชั้นหนึ่งสู่หนองคาย แล้วข้ามแม่น้ำโขงสู่เวียงจันทน์ด้วยรถตู้ที่จัดเตรียมไว้ ทุกช่วงจัดการผ่านพื้นที่สำหรับแขกของคุณ", "一等寝台で夜を越えてノーンカーイへ、そして手配されたバンでメコンを渡りビエンチャンへ。各行程はゲストエリアで手配されます。");
  /* MASTER-02 minimal invitation landing */
  E("Enter the Journey", "Die Reise betreten", "เข้าสู่การเดินทาง", "旅へ入る");
  ...
  E("One day in Vientiane that the whole journey leans toward.", "Ein Tag in Vientiane, auf den die ganze Reise zul\u00e4uft.", "หนึ่งวันในเวียงจันทน์ที่ทั้งการเดินทางมุ่งไปหา", "旅のすべてが向かうビエンチャンでの一日。");
  ...
  E("Discover the journey", "Die Reise entdecken", "ค้นพบการเดินทาง", "旅を見る");
  E("Discover Thailand", "Thailand entdecken", "ค้นพบประเทศไทย", "タイを見る");
  E("Discover Laos", "Laos entdecken", "ค้นพบลาว", "ラオスを見る");
  E("Discover China", "China entdecken", "ค้นพบจีน", "中国を見る");
  E("Journey 01 · Thailand", "Reise 01 · Thailand", "การเดินทาง 01 · ประเทศไทย", "旅 01 · タイ");
  E("Journey 02 · Laos", "Reise 02 · Laos", "การเดินทาง 02 · ลาว", "旅 02 · ラオス");
  E("Journey 03 · China", "Reise 03 · China", "การเดินทาง 03 · จีน", "旅 03 · 中国");
  E("Bangkok", "Bangkok", "กรุงเทพฯ", "バンコク");
  E("Vientiane", "Vientiane", "เวียงจันทน์", "ビエンチャン");
  E("Kunming & Lijiang", "Kunming & Lijiang", "คุนหมิงและลี่เจียง", "昆明と麗江");
  E("The shared city days before the wedding — the river, the temples, the night train waiting to go north.", "Die gemeinsamen Stadttage vor der Hochzeit — der Fluss, die Tempel, der Nachtzug, der nach Norden wartet.", "วันในเมืองด้วยกันก่อนงานแต่ง ทั้งแม่น้ำ วัด และรถไฟกลางคืนที่รอมุ่งขึ้นเหนือ", "結婚式前の街での日々 — 川、寺院、北へ向かう夜行列車。");
  E("The quiet capital on the Mekong, and the one day the whole journey leans toward.", "Die stille Hauptstadt am Mekong — und der eine Tag, auf den die ganze Reise zuläuft.", "เมืองหลวงอันเงียบสงบริมแม่น้ำโขง และวันหนึ่งที่ทั้งการเดินทางมุ่งไปหา", "メコンの静かな首都、そして旅のすべてが向かう一日。");
  E("After the wedding: the city of eternal spring, and the old town beneath Jade Dragon Snow Mountain.", "Nach der Hochzeit: die Stadt des ewigen Frühlings und die Altstadt unter dem Jadedrachen-Schneeberg.", "หลังงานแต่ง เมืองแห่งฤดูใบไม้ผลินิรันดร์ และเมืองเก่าใต้ภูเขาหิมะมังกรหยก", "結婚式の後は、常春の街と玉龍雪山のふもとの旧市街へ。");
  E("The complete journey — 21 February to 6 March 2027 — opens with the private code from your invitation.", "Die vollständige Reise — 21. Februar bis 6. März 2027 — öffnet sich mit dem persönlichen Code aus eurer Einladung.", "การเดินทางทั้งหมด 21 กุมภาพันธ์ – 6 มีนาคม 2027 เปิดด้วยรหัสส่วนตัวจากคำเชิญของคุณ", "2027年2月21日〜3月6日の旅は、招待状のプライベートコードで開きます。");
  E("Lost your code? Write to", "Code verloren? Schreibt an", "รหัสหาย? เขียนถึง", "コードを紛失した場合は、こちらへ");
  E("Destinations", "Reiseziele", "จุดหมายปลายทาง", "旅先");
  E("Plan your journey", "Plane deine Reise", "วางแผนการเดินทางของคุณ", "旅を計画する");
  E("Journey & Dates", "Reise & Daten", "การเดินทางและวันที่", "旅と日程");
  E("Stay & Travel", "Aufenthalt & Reise", "ที่พักและการเดินทาง", "滞在と移動");
  E("Experiences", "Erlebnisse", "ประสบการณ์", "体験");
  ...
  E("The temple in the morning, coffee and cake on the return, the vows at the green door and dinner poolside. Coffee and cake, the vows and the dinner are hosted for every guest; Buddhist giving at the temple is personal.", "Der Tempel am Morgen, Kaffee und Kuchen nach der Rückkehr, das Trauversprechen an der grünen Tür und das Dinner am Pool. Kaffee und Kuchen, die Trauung und das Dinner sind für jeden Gast ausgerichtet; die buddhistische Gabe im Tempel ist persönlich.", "วัดในตอนเช้า กาแฟและเค้กเมื่อกลับมา คำสาบานที่ประตูสีเขียว และมื้อค่ำริมสระว่ายน้ำ กาแฟและเค้ก พิธีสาบาน และมื้อค่ำจัดเตรียมให้แขกทุกท่าน ส่วนการทำบุญที่วัดเป็นเรื่องส่วนตัวของแต่ละท่าน", "朝は寺院へ、戻ってコーヒーとケーキ、緑の扉での誓い、そしてプールサイドでのディナー。コーヒーとケーキ、誓い、ディナーはすべてのゲストのためにご用意しています。寺院でのお布施はご自身で。");
  ...
  E("Three Bangkok days together, then the night train north to Vientiane.", "Drei gemeinsame Bangkok-Tage, dann der Nachtzug nach Norden nach Vientiane.", "สามวันในกรุงเทพฯ ด้วยกัน แล้วขึ้นรถไฟกลางคืนขึ้นเหนือสู่เวียงจันทน์", "皆で過ごすバンコク三日間、そして夜行列車で北のビエンチャンへ。");
  ...
  E("Laos", "Laos", "ลาว", "ラオス");
  E("China", "China", "จีน", "中国");
  E("21 – 24 Feb · Bangkok, Nong Khai", "21. – 24. Feb · Bangkok, Nong Khai", "21 – 24 ก.พ. · กรุงเทพฯ, หนองคาย", "2月21〜24日 · バンコク、ノンカーイ");
  E("27 Feb – 01 Mar · the wedding", "27. Feb – 01. März · die Hochzeit", "27 ก.พ. – 1 มี.ค. · งานแต่งงาน", "2月27日〜3月1日 · 結婚式");
  E("01 – 06 Mar · Kunming, Lijiang", "01. – 06. März · Kunming, Lijiang", "1 – 6 มี.ค. · คุนหมิง, ลี่เจียง", "3月1〜6日 · 昆明、麗江");
  E("One invitation · three journeys", "Eine Einladung · drei Reisen", "หนึ่งคำเชิญ · สามการเดินทาง", "ひとつの招待 · 三つの旅");
  E("The three journeys", "Die drei Reisen", "การเดินทางทั้งสาม", "三つの旅");
  E("Contact Guest Relations", "Guest Relations kontaktieren", "ติดต่อ Guest Relations", "ゲストリレーションへ連絡");
  E("The wedding", "Die Hochzeit", "งานแต่งงาน", "結婚式");
  E("Your Invitation", "Eure Einladung", "คำเชิญของคุณ", "あなたの招待状");
  E("Join the journey", "Der Reise beitreten", "ร่วมการเดินทาง", "旅に参加する");
