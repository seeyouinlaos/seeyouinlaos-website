...
(function () {
  ...
  header.innerHTML =
    '<div class="hd-row">' +
      ...
      '<div class="hd-right"><a class="hd-cta bag" href="your-journey.html" aria-label="Your Journey"><svg class="bgi" viewBox="0 0 26 26" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M4.6 10.4h16.8l-1.15 11.3a1.3 1.3 0 0 1-1.3 1.15H7.05a1.3 1.3 0 0 1-1.3-1.15z"/><path d="M4.6 10.4h16.8v2.6a.9.9 0 0 1-.9.9h-1.9a.9.9 0 0 1-.9-.9v-.9H9.3v.9a.9.9 0 0 1-.9.9H6.5a.9.9 0 0 1-.9-.9z"/><path d="M9.3 10.4V8.1a3.7 3.7 0 0 1 7.4 0v2.3"/><path d="M11.9 12.1h2.2v2.4h-2.2z"/></svg><span class="bb" data-bag-badge></span></a></div>' +
    '</div>' +
    '';
