...
window.SIYL_EXP = [
  ...
  { id: 'vte-laonationalmuseum', category: 'experience', roles: ['experience'], visits: [], row: 'city', chapter: 'laos', day: 'Museums', name: 'Lao National Museum', where: 'Vientiane', cats: 'Museum · History · Heritage',
    ...
    teaser: 'The story of Laos from prehistory to the present, in the national museum’s new building.',
    detail: [
      ...
      'Since 2017 the museum has had its own new building, six kilometres from the centre of Vientiane, where the collections run from prehistory to the present.'
    ],
    practical: { price: 'LAK 30,000 per person for foreign visitors · LAK 5,000 for Lao nationals', hours: ['Monday – Friday 08:00 – 16:00', 'Saturday – Sunday 09:00 – 16:00'] } },
