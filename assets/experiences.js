...
window.SIYL_EXP = [
  ...
  { id: 'bkk-dior', category: 'cafe', roles: ['cafe'], visits: [{ day: 2, date: '2027-02-22', seq: 1245, what: 'Coffee' }], row: 'Day 02 · 22.02.2027', chapter: 'bkk', day: '22 FEB 2027', name: 'Dior Café', where: 'Bangkok', cats: 'Couture · Design · Café', img: 'assets/images/experiences/bkk-dior-02.jpg', teaser: 'Café Dior at the maison on Sukhumvit — a gold cannage salon, a garden table, French pastry in the quiet of the afternoon.' },
  { id: 'bkk-lvcafe', category: 'cafe', roles: ['cafe'], visits: [{ day: 2, date: '2027-02-22', seq: 1245, what: 'Coffee' }], row: 'Day 02 · 22.02.2027', chapter: 'bkk', day: '22 FEB 2027', name: 'LV Café', where: 'Bangkok', cats: 'Maison · Design · Café', img: 'assets/images/experiences/bkk-lvcafe-02.jpg', teaser: 'Le Café Louis Vuitton at Gaysorn Amarin — a round dining room behind the sculpted façade, the library wall, coffee among the trunks.' },
  ...
  { id: 'bkk-cafecraft', category: 'cafe', roles: ['cafe'], visits: [{ day: 15, date: '2027-03-07', seq: 1500, what: 'Coffee' }], row: 'Day 15 · 07.03.2027', chapter: 'bkk', leg: 'return', day: '07 MAR 2027', name: 'Café Craft by CHANINTR', where: 'Bangkok', cats: 'Café · Design', img: 'assets/images/experiences/bkk-cafecraft-01.jpg', teaser: 'The afternoon coffee of the last Sunday — a design house’s café in the heart of the city.' },
  { id: 'bkk-siamparagon', category: 'place', roles: ['place'], visits: [{ day: 15, date: '2027-03-07', seq: 1700, what: 'Shopping' }], row: 'Day 15 · 07.03.2027', chapter: 'bkk', leg: 'return', day: '07 MAR 2027', name: 'Siam Paragon', where: 'Bangkok', cats: 'Shopping · Siam', img: 'assets/images/experiences/bkk-siamparagon-01.jpg', teaser: 'The last afternoon in the city — the grand mall at Siam, beside the Kempinski.' },
  { id: 'bkk-firefly', category: 'bar', roles: ['bar'], visits: [{ day: 15, date: '2027-03-07', seq: 2100, what: 'Drinks' }], row: 'Day 15 · 07.03.2027', chapter: 'bkk', leg: 'return', day: '07 MAR 2027', name: 'Firefly Bar, Siam Kempinski', where: 'Bangkok', cats: 'Bar · The last night', img: 'assets/images/experiences/bkk-firefly-01.jpg', teaser: 'The last night of the journey — a bar at the Siam Kempinski, after the dinner at Cannubi.' },
  ...
  { id: 'vte-lecafe', category: 'cafe', roles: ['cafe'], visits: [{ day: 7, date: '2027-02-27', seq: 1500, what: 'Coffee' }], row: 'Day 07 · 27.02.2027', chapter: 'laos', day: '27 FEB 2027', name: 'Le Café at Souphattra Heritage', where: 'Vientiane', cats: 'Café · The house', img: 'assets/images/experiences/vte-lecafe-01.jpg', teaser: 'The café of the house itself — coffee in the courtyard on the afternoon the guests arrive.' },
  { id: 'vte-selene', category: 'bar', roles: ['bar'], visits: [{ day: 7, date: '2027-02-27', seq: 2100, what: 'Drinks' }], row: 'Day 07 · 27.02.2027', chapter: 'laos', day: '27 FEB 2027', name: 'Selene Sky Bar', where: 'Vientiane', cats: 'Sky bar · Evening', img: 'assets/images/experiences/vte-selene-01.jpg', teaser: 'A drink above the city on the welcome evening, after the dinner at Lao Derm.' },
  ...
  { id: 'vte-laodress', category: 'experience', roles: ['experience'], visits: [], row: 'city', chapter: 'laos', day: 'Traditional attire', name: 'Lao Traditional Dress Rental', where: 'Vientiane', cats: 'Traditional attire · Lao silk',
    ...
    teaser: 'The group will wear classic Lao traditional attire made from fine Lao silk, reflecting the timeless elegance and cultural heritage of Laos while maintaining a relaxed and effortless overall look.',
    detail: [
      'Women will wear beautifully patterned sinh (traditional Lao wrap-around skirts), paired with elegant silk blouses and gracefully draped sashes. Simple flat or low-heeled leather sandals in neutral tones such as tan, brown, black, nude, or cream are encouraged.',
      'Men will wear traditional Lao silk shirts, paired with sinh or traditional trousers, complemented by coordinating silk sashes where appropriate. Simple leather sandals or relaxed leather loafers in brown, tan, or black are recommended.',
      'The overall styling should feel natural, refined, and understated, with coordinated yet individual variations in traditional patterns, textures, and colors. Footwear should remain simple and comfortable, complementing the traditional silk attire without making the look overly formal or theatrical.',
      'Please note: Guests are kindly asked to bring their own footwear. The rental service will provide the traditional shirt, sinh or trousers, and accessories only.'
    ],
    practical: { price: 'USD 15.00', hours: ['Everyday 09:00 – 18:00'] } },
