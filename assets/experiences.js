...
window.SIYL_EXP = [
  ...
  { id: 'bkk-phranakorn', chapter: 'bkk', day: '22 FEB 2027', name: 'Phra Nakhon', where: 'Bangkok', cats: 'Thai dining · Riverside', img: 'assets/images/experiences/bkk-phranakorn-01.jpg', teaser: 'A Bangkok dining destination for contemporary Thai cooking.' },
  { id: 'bkk-socialclub', chapter: 'bkk', day: '22 FEB 2027', name: 'BKK Social Club', where: 'Bangkok', cats: 'Bar · Design · Evening', img: 'assets/images/experiences/bkk-social-01.jpg', teaser: "One of the city's great bars — Buenos Aires glamour, considered drinks, late light." },
  { id: 'bkk-timespace', chapter: 'bkk', day: '23 FEB 2027', name: 'Time Space Cafe', where: 'Bangkok', cats: 'Café · Design', img: 'assets/images/experiences/bkk-timespace-01.jpg', teaser: 'Coffee and bakery in a room built around light and pause.' },
  { id: 'bkk-mooyoo', chapter: 'bkk', day: '23 FEB 2027', name: 'Moo Yoo Rose House', where: 'Bangkok', cats: 'House · Garden · Café', img: 'assets/images/experiences/bkk-mooyoo-01.jpg', teaser: 'A house of roses — a visual café where Italian fusion meets Thai sweetness.' },
  ...
  { id: 'bkk-barus', chapter: 'bkk', day: '23 FEB 2027', name: 'Bar Us', where: 'Bangkok', cats: 'Bar · Evening · Design', maps: 'https://maps.app.goo.gl/2KLduE51ybg4qAqd9?g_st=ic', img: 'assets/images/experiences/bkk-barus-01.jpg', teaser: 'An intimate evening alternative — a small bar of precision and warmth.' },
  { id: 'bkk-igniv', chapter: 'bkk', day: '23 FEB 2027', name: 'IGNIV', where: 'Bangkok', cats: 'Dining · Evening', maps: 'https://maps.app.goo.gl/vkS23W4viFPRWkf78?g_st=ic', img: 'assets/images/experiences/bkk-igniv-01.jpg', teaser: 'A sharing-menu evening alternative — fine dining made convivial.' },
  { id: 'bkk-thongsmith', chapter: 'bkk', day: '24 FEB 2027', name: 'Thong Smith', where: 'Bangkok', cats: 'Thai · Boat Noodles', img: 'assets/images/experiences/bkk-thongsmith-01.jpg', teaser: 'Siamese boat noodles, elevated — a Bangkok classic done beautifully.' },
  ...
  { id: 'bkk-madeleine', chapter: 'bkk', day: '24 FEB 2027', name: 'Cafe Madeleine', where: 'Four Seasons Hotel Bangkok', cats: 'Pâtisserie · Hotel · Café', img: 'assets/images/experiences/bkk-madeleine-01.jpg', teaser: "Refined hotel pâtisserie — French pastry in the Four Seasons' calm." },
  { id: 'bkk-tangjaiyang', chapter: 'bkk', day: '24 FEB 2027', name: 'Tang Jai Yang', where: 'Bangkok', cats: 'Cantonese · Charcoal · Dining', maps: 'https://maps.app.goo.gl/6otfQcm4bqsTuWZ16?g_st=ic', img: 'assets/images/experiences/bkk-tjy-01.jpg', teaser: 'Cantonese charcoal barbecue — smoke, lacquer and generations of craft.' },
  ...
  { id: 'vte-thatluang', chapter: 'laos', featured: true, day: 'Gold & sacred', name: 'Pha That Luang', where: 'Vientiane', cats: 'Heritage · Architecture · Culture', maps: 'https://maps.app.goo.gl/hehafVRBrdPt7L9Y6?g_st=ic',
  ...
  { id: 'vte-patuxai', chapter: 'laos', featured: true, day: 'City & architecture', name: 'Patuxai', where: 'Vientiane', cats: 'Monument · Architecture · City',
    img: 'assets/images/experiences/vte-patuxai-01.jpg',
    gallery: ['assets/images/experiences/vte-patuxai-01.jpg', 'assets/images/experiences/vte-patuxai-02.jpg'],
  ...
  { id: 'vte-nightmarket', chapter: 'laos', featured: true, day: 'Mekong & evening', name: 'Vientiane Night Market', where: 'Vientiane', cats: 'Night market · Riverfront · Local life', maps: 'https://maps.app.goo.gl/X2jTe6DyVCc7qd21A?g_st=ic',
    img: 'assets/images/experiences/vte-nightmarket-01.jpg',
    gallery: ['assets/images/experiences/vte-nightmarket-01.jpg', 'assets/images/experiences/vte-mekong-01.jpg'],
  ...
  { id: 'vte-sisaket', chapter: 'laos', day: 'Gold & sacred', name: 'Wat Si Saket', where: 'Vientiane', cats: 'Temple · Heritage · Museum',
  ...
  { id: 'vte-simuang', chapter: 'laos', day: 'Gold & sacred', name: 'Wat Si Muang', where: 'Vientiane', cats: 'Temple · Local life · Sacred',
  ...
  { id: 'vte-haphrakeo', chapter: 'laos', day: 'Gold & sacred', name: 'Ha Phrakeo Museum', where: 'Vientiane', cats: 'Museum · Heritage · Garden',
  ...
  { id: 'vte-palace', chapter: 'laos', day: 'City & architecture', name: 'Presidential Palace', where: 'Vientiane', cats: 'Landmark · Architecture',
  ...
  { id: 'vte-thatdam', chapter: 'laos', day: 'City & architecture', name: 'That Dam', where: 'Vientiane', cats: 'Stupa · Legend · City',
  ...
  { id: 'vte-buddhapark', chapter: 'laos', day: 'Beyond the centre', name: 'Buddha Park', where: 'Xieng Khuan · Vientiane', cats: 'Sculpture park · Riverside · Day escape',
  ...
  { id: 'vte-lacuna', chapter: 'laos', day: '26 FEB 2027', name: 'Lacuna VTE', where: 'Vientiane', cats: 'Café · Design', maps: 'https://maps.app.goo.gl/tzMFhWFGAWjE2ALs8?g_st=ic', img: 'assets/images/experiences/vte-lacuna-01.jpg', teaser: 'A quiet design café — considered coffee in a considered room.' },
  ...
  { id: 'vte-laoderm', chapter: 'laos', day: '26 FEB 2027', name: 'Lao Derm', where: 'Vientiane', cats: 'Lao · Dining', maps: 'https://maps.app.goo.gl/cSn9mzR38QdKGsk49?g_st=ic', img: 'assets/images/experiences/vte-laoderm-01.jpg', teaser: 'An evening alternative — classic Lao dining, warm and unhurried.' },
