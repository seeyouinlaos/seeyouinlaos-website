...
// src/worker.js
var GR_EMAIL = "guest.relation.seeyouinlaos@gmail.com";
...
async function handleRegister(request, env2) {
  ...
  const submittedAt = registration && registration.registration_submitted_at || (/* @__PURE__ */ new Date()).toISOString();
  let stored = false;
  let mailed = false;
  if (env2.REG_KV) {
    try {
      await env2.REG_KV.put(
